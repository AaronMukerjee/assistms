...
public class ExceptionControllerAdvice {
	...
	public ResponseEntity<ExceptionResponse> handleTrainingDataFetchException(IntentNotCreatedException ex){
		ExceptionResponse response = new ExceptionResponse();
	...
	public ResponseEntity<ExceptionResponse> handleTrainingDataInsertionException(IntentNotCreatedException ex){
		ExceptionResponse response = new ExceptionResponse();
